    ...
    <main className="healthHistory">
      <div className="container">
        <section className="left-side">
          <div style={{ background: "#119acc", display: "flex", flexDirection: "column", width: "26rem", borderRadius: "10px 10px 0 0" }}>
            <div style={{ display: "flex", padding: "1rem 1rem", alignItems: "center" }}>
              ...
              <button style={{ color: "white", backgroundColor: "#119acc", border: "1px solid white", borderRadius: "30px", padding: "10px 20px" }} onClick={() => setPhysmodal(!physmodal)}>
                Edit
              </button>
            </div>
        ...
        <section className="right-side">
          <div style={{ width: "23rem", borderBottom: "3px solid #d4d4d4", padding: "1rem 1.5rem", color: "#119acc" }}>
            <h3>Summary</h3>
          </div>
          ...
          <div style={{ display: "flex", color: "#666666", marginTop: "4px", padding: "5px 1rem" }}>
            ...
            <button
              className="threedots"
              style={{ color: "white", backgroundColor: "#119acc", border: "1px solid white", borderRadius: "30px", padding: "0px 20px" }}
