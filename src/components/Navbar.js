        ...
        <div className='navbar'>
            <div className='container' >
                <div style={{ display: "flex", alignItems: "center", gap: "3rem" }}>
                    {isSideMenu ? (<FaTimes style={{ fontSize: "25px", marginLeft: "20px", cursor: "pointer" }} onClick={() => setIsSideMenu(prev => !prev)} />) : (<AiOutlineMenu style={{ fontSize: "25px", marginLeft: "20px", cursor: "pointer" }} onClick={() => setIsSideMenu(prev => !prev)} />)}
                    <Link to="/">
            ...
            <div className={isSideMenu ? 'side-menu_active' : 'side-menu'}>
                <ul className='side-menu-list-div'>
                    <Link className='sidemenu-link' to="/"><li>Dashboard</li></Link>
                    <Link className='sidemenu-link' to="/taskboard"><li>Task Board</li></Link>
                    <Link className='sidemenu-link' to="/personaldetail"><li>Personal Details</li></Link>
