        ...
        <main className="updatePD">
            ...
            <form className="detailFields">
                <div className="form-div">
                    ...
                    <input id="name" type="text" placeholder="George" />
                </div>
                <div className="form-div">
                    <label htmlFor="id">Middle Name</label>
                    <input id="id" type="text" />
                </div>
                <div className="form-div">
                    <label htmlFor="phone">Last Name</label>
                    <input id="phone" type="text" placeholder="Calan" />
                </div>
                <div className="form-div">
                ...
                <div className="form-div">
                    <label htmlFor="email">Actual Date Of Birth</label>
                ...
                <div className="form-div">
                    ...
                    <select id="marital" placeholder="Unmarried">
                ...
                <div className="form-div">
                    ...
                    <input id="mobile" type="number" placeholder="9812812712" />
                </div>
